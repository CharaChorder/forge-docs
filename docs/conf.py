...
# Canonical URL
html_baseurl = 'https://docs.forgekeyboard.com'

# Logos/icons
html_logo = 'assets/images/Forge-logo.png'
...
latex_documents = [
    (master_doc, 'ForgeKeyboard.tex', 'Forge Keyboard Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'Forge Keyboard', 'Forge Keyboard Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Forge Keyboard', 'Forge Keyboard Documentation',
     author, 'Forge', 'Forge Keyboard Documentation',
     'Miscellaneous'),
]
